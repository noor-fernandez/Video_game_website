...
if (isset($_POST['Game_Name'])) {
  ...
  $game = mysqli_real_escape_string($connect,$_POST['Game_Name']); // Real escape string offers enhanced security
...
<a href="modern_games_list.php"> Return to modern games list </a>
</body>
</html>
